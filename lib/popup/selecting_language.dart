...
class SelectingLanguage extends StatelessWidget {
  const SelectingLanguage({super.key, required this.onTap, required this.data});
                ...
                child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return GestureDetector(
                        onTap: () {
                          onTap.call(data[index].language, data[index].id);
                          Get.back();
                        },
                        child: Container(
                          ...
                          child: Text(data[index].language, style: TextStyle(
                              fontFamily: ColorFontUtil.poppins,
                              color: ColorFontUtil.black25
                          ),),
                        ),
