...
class SelectingRole extends StatelessWidget {
  const SelectingRole({super.key, required this.onTap, required this.data});
                ...
                child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return GestureDetector(
                        onTap: () {
                          onTap.call(data[index].role, data[index].id);
                          Get.back();
                        },
                        child: Container(
                          ...
                          child: Text(data[index].role, style: TextStyle(
                              fontFamily: ColorFontUtil.poppins,
                              color: ColorFontUtil.black25
                          ),),
                        ),
